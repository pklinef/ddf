...
public class ContentDirectoryMonitorIT extends AbstractComponentTest {
  ...
  private List<BundleInfo> contentDirectoryMonitorDependencies() {
    return Arrays.asList(
        ...
        new BundleInfo("ddf.modules.catalog.core", "catalog-core-camelcontext"),
        ...
        new BundleInfo("ddf.modules.catalog.core", "catalog-core-camelcomponent"),
        new BundleInfo("ddf.modules.catalog.transformer", "tika-input-transformer"),
        ...
        new BundleInfo("ddf.modules.catalog.transformer", "catalog-transformer-bootflag"),
